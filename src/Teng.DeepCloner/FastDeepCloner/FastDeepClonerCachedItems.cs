    ...
    internal static class FastDeepClonerCachedItems
    {
        ...
        internal static object Value(object value, Type dataType, bool loadDefaultOnError, object defaultValue = null)
        {
            ...
            try
            {
                ...
                {
                    if (DateTimeOffset.TryParse(value.ToString(), Culture, DateTimeStyles.None, out var dateValue))
                    {
        ...
        internal static object ConvertToInterface(this Type interfaceType, object item)
        {
            ...
            var newtype = CachedConvertedObjectToInterface.ContainsKey(key) ? CachedConvertedObjectToInterface[key] : CachedConvertedObjectToInterface.GetOrAdd(key, ConvertToInterfaceTypeGenerator.Convert(interfaceType, type));
            ...
            try
            {
                ...
                if (constructor != null)
                {
                    ...
                    else
                    {
                        ...
                        System.Linq.Expressions.Expression[] argsExpressions = new Expression[constParam.Length];
